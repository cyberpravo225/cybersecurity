(function initStudents911Practice() {
  ...
  const cards = [
    ...
    },
    {
      ...
      type: 'game',
      icon: '🧭',
      title: 'Игра: OSINT-трассировка',
      description: 'Определи, какие открытые данные можно использовать безопасно, а какие — нет.',
      challenge: {
        intro: 'Ты проверяешь подозрительный профиль перед школьным хакатоном.',
        question: 'Какой источник лучше использовать для первичной проверки профиля?',
        answers: [
          { text: 'Случайный Telegram-канал без авторства', correct: false, explain: 'Непроверенные источники часто распространяют фейки.' },
          { text: 'Официальный сайт конкурса и подтверждённые соцсети организаторов', correct: true, explain: 'Первичные и верифицированные источники — лучший старт.' },
          { text: 'Скриншот из анонимного чата', correct: false, explain: 'Скриншоты легко подделываются и теряют контекст.' }
        ],
        success: 'Верно. В OSINT сначала проверяют первоисточник и подтверждаемость фактов.'
      }
    },
    {
      id: 'phishing-chain',
      type: 'game',
      icon: '📨',
      title: 'Игра: Разорви фишинг-цепочку',
      description: 'Выбери действие, которое остановит распространение фишинга в школьном чате.',
      challenge: {
        intro: 'В чате рассылают ссылку «СРОЧНО подтвердите доступ к дневнику».',
        question: 'Какое действие эффективнее всего в первые минуты?',
        answers: [
          { text: 'Переслать сообщение всем, чтобы предупредить', correct: false, explain: 'Так можно невольно усилить охват вредной ссылки.' },
          { text: 'Проверить домен, удалить сообщение и сообщить администратору/учителю', correct: true, explain: 'Это быстро снижает риск и запускает контроль инцидента.' },
          { text: 'Игнорировать и ждать, пока ситуация решится сама', correct: false, explain: 'Промедление обычно увеличивает число пострадавших.' }
        ],
        success: 'Отлично. Быстрая эскалация и удаление вредной ссылки реально останавливают атаку.'
      }
    },
    {
      ...
      type: 'game',
      icon: '🔒',
      title: 'Игра: Архитектор приватности',
      description: 'Настрой безопасный профиль: выбери параметры, снижающие цифровой риск.',
      challenge: {
        intro: 'Ты настраиваешь публичный профиль школьного проекта.',
        question: 'Какой набор настроек наиболее безопасный?',
        answers: [
          { text: 'Публичный номер телефона + открытые комментарии для всех', correct: false, explain: 'Это увеличивает риск спама и социальной инженерии.' },
          { text: 'Скрыть контакты, ограничить личные сообщения, включить 2FA', correct: true, explain: 'Комбинация приватности и 2FA заметно снижает риски.' },
          { text: 'Оставить всё открытым ради большего охвата', correct: false, explain: 'Охват без ограничений повышает вероятность злоупотреблений.' }
        ],
        success: 'Верно. Приватность + MFA — базис безопасного цифрового профиля.'
      }
    }
  ];
