...
/* =========================
   Global animated/static background mode
   ========================= */
(function(){
  if (!window.initCyberBackgroundMode) {
    window.initCyberBackgroundMode = function initCyberBackgroundMode() {
      ...
      const current = localStorage.getItem(storageKey) === 'static' ? 'static' : 'animated';
      root.setAttribute('data-bg-mode', current);
      ...
      button.addEventListener('click', () => {
        const prev = root.getAttribute('data-bg-mode') === 'static' ? 'static' : 'animated';
        const next = prev === 'animated' ? 'static' : 'animated';
